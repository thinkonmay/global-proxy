module github.com/thinkonmay/global-proxy/api
...
require (
	...
	github.com/thinkonmay/thinkshare-daemon v0.0.0
...
replace github.com/thinkonmay/thinkshare-daemon => ../worker/daemon
