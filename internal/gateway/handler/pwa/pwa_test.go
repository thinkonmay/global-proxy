...
func TestPWAAppInfo(t *testing.T) {
	...
	h := New(testPWAConfig(), postgrest.New(postgrest.Config{URL: srv.URL, ServiceKey: "svc"}), nil, persona.New(postgrest.New(postgrest.Config{URL: srv.URL, ServiceKey: "svc"}), nil))
